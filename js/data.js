...
// AQ (full 50-item): Baron-Cohen S, et al. (2001). J Autism Dev Disord, 31(1), 5–17.
// Threshold ≥32/50. Score direction: true=agree, false=disagree (autistic direction).
const AQ50_SCORE_IF_AGREE = [
...
const AQ50_MAX       = 50;
const AQ50_THRESHOLD = 32;
const AQ50_Q = {
  it: [
    "Preferisco fare le cose con gli altri piuttosto che da solo/a.",
    "Preferisco fare le cose sempre nello stesso modo.",
    "Quando cerco di immaginare qualcosa, mi è molto facile creare un'immagine nella mente.",
    "Spesso mi assorbo talmente in una cosa da perdere di vista tutto il resto.",
    "Noto spesso piccoli suoni che gli altri non sentono.",
    "Di solito noto le targhe delle auto o stringhe simili di informazioni.",
    "Le persone mi dicono spesso che quello che ho detto è scortese, anche se penso di essere educato/a.",
    "Quando leggo una storia, mi è facile immaginare com'è fisicamente ogni personaggio.",
    "Le date mi affascinano.",
    "In un gruppo sociale, riesco facilmente a seguire i diversi discorsi di più persone contemporaneamente.",
    "Trovo facili le situazioni sociali.",
    "Tendo a notare i dettagli che gli altri non notano.",
    "Preferirei andare in biblioteca piuttosto che a una festa.",
    "Trovo facile inventare storie.",
    "Mi sento più attratto/a dalle persone che dalle cose.",
    "Tendo ad avere interessi molto forti che mi turbano se non posso coltivare.",
    "Mi piace fare chiacchiere sociali.",
    "Quando parlo, non è sempre facile per gli altri riuscire a inserirsi nella conversazione.",
    "I numeri mi affascinano.",
    "Quando leggo una storia, trovo difficile capire le intenzioni dei personaggi.",
    "Non mi piace particolarmente leggere narrativa.",
    "Trovo difficile fare nuove amicizie.",
    "Noto sempre degli schemi nelle cose.",
    "Preferirei andare a teatro piuttosto che a un museo.",
    "Non mi disturba che la mia routine quotidiana venga interrotta.",
    "Spesso mi trovo a non sapere come tenere viva una conversazione.",
    "Riesco facilmente a capire le sfumature di quello che mi sta dicendo qualcuno.",
    "Di solito mi concentro più sul quadro complessivo anziché sui piccoli dettagli.",
    "Non sono bravo/a a ricordare i numeri di telefono.",
    "Di solito non noto i piccoli cambiamenti in una situazione o nell'aspetto di una persona.",
    "Riconosco quando chi mi sta ascoltando si sta annoiando.",
    "Riesco facilmente a fare più cose contemporaneamente.",
    "Quando parlo al telefono, non sono sicuro/a di quando tocca a me parlare.",
    "Mi piace fare le cose spontaneamente.",
    "Spesso sono l'ultimo/a a capire il senso di una barzelletta.",
    "Riesco facilmente a capire cosa sta pensando o provando una persona guardandola in viso.",
    "Se vengo interrotto/a, riesco facilmente a riprendere quello che stavo facendo.",
    "Sono bravo/a a fare chiacchiere sociali.",
    "Le persone mi dicono spesso che continuo a parlare dello stesso argomento.",
    "Da giovane mi piaceva giocare con altri bambini a giochi di fantasia.",
    "Mi piace raccogliere informazioni su categorie di cose (auto, uccelli, treni, piante...).",
    "Trovo difficile immaginare com'è essere un'altra persona.",
    "Mi piace pianificare con cura qualsiasi attività a cui partecipo.",
    "Mi piacciono le occasioni sociali.",
    "Trovo difficile capire le intenzioni delle persone.",
    "Le situazioni nuove mi rendono ansioso/a.",
    "Mi piace incontrare nuove persone.",
    "Sono un/a buon/a diplomatico/a.",
    "Non sono bravo/a a ricordare le date di nascita delle persone.",
    "Trovo molto facile giocare con i bambini a giochi di fantasia.",
  ],
  en: [
